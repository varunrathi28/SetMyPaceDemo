...
- (void)commonInit {
    ...
    self.opaque = NO;
    _selectionIndicatorColor = [MySingleton sharedManager].themeGlobalBlackColor;
...
//    };
    ...
    NSDictionary *defaults = @{
        NSFontAttributeName : [MySingleton sharedManager].themeFontElevenSizeRegular,
        NSForegroundColorAttributeName : [MySingleton sharedManager].themeGlobalLightGreyColor,
    };
...
- (NSDictionary *)resultingSelectedTitleTextAttributes {
    NSDictionary *defaults = @{
        NSFontAttributeName : [MySingleton sharedManager].themeFontElevenSizeRegular,
        NSForegroundColorAttributeName : [MySingleton sharedManager].themeGlobalBlackColor,
    };
    NSMutableDictionary *resultingAttrs = [NSMutableDictionary dictionaryWithDictionary:defaults];
