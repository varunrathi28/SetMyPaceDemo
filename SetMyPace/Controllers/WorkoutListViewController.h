...
@interface WorkoutListViewController : UIViewController<UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, TheSidebarControllerDelegate>
...
@property (nonatomic,retain) IBOutlet UILabel *lblNoWorkoutsAdded;
